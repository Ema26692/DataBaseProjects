...
--metemos 3 registros en customers
...
--jala el precio de tabla producto e inserta en orderDetails
--aqui corremos los 2 select para visualizar la info de ambas tablas
...
--inserted es una tabla temporal creada despues del insert del trigger('for insert')
